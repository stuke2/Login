...
$_lang['prop_login.rememberme_desc'] = 'Optionnel. Le nom du champ de la bascule Se rappeler de moi pour préserver l’état de la connexion. Par défaut, `rememberme`.';
...
$_lang['prop_register.ensurePasswordStrengthSuggestions'] = 'Si ensurePasswordStrength est défini sur Oui, et que le mot de passe a échoué au test de complexité, Register fournira plusieurs suggestions pour le mot de passe de l’utilisateur .';
