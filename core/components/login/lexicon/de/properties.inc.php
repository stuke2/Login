...
$_lang['prop_register.generatepassword_desc'] = 'Wenn diese Einstellung aktiv ist, generiert Register ein zufälliges Kennwort für den Benutzer und überschreibt jedes übergebene Passwort. Nützlich für die automatische Generierung von Passwörtern.';
$_lang['prop_register.trimpassword_desc'] = 'Wenn diese Einstellung aktiv ist, entfernt Register beim übermittelten Kennwort überflüssigen Leerraum.';
$_lang['prop_register.ensurePasswordStrength_desc'] = 'Wenn diese Einstellung aktiv ist, stellt Register sicher, dass der Benutzer ein starkes und sicheres Kennwort eingibt. Sichere Kennwörter bestehen aus mehreren Wörtern oder enthalten nicht-alphabetische Zeichen.';
